...
function $f_Lnl_amsscala_sjsgameoflive_CanvasComponent__equals__O__Z($thiz, that) {
  if ($is_Lnl_amsscala_sjsgameoflive_CanvasComponent(that)) {
    var x2 = $as_Lnl_amsscala_sjsgameoflive_CanvasComponent(that);
    var x = $thiz.pos__Lnl_amsscala_sjsgameoflive_package$Position();
    var x$2 = x2.pos__Lnl_amsscala_sjsgameoflive_package$Position();
    return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
  } else {
    return false
  }
}
function $f_Lnl_amsscala_sjsgameoflive_CanvasComponent__toString__T($thiz) {
  return new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["", " ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$objectGetClass($thiz).getSimpleName__T(), $thiz.pos__Lnl_amsscala_sjsgameoflive_package$Position()]))
}
function $is_Lnl_amsscala_sjsgameoflive_CanvasComponent(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnl_amsscala_sjsgameoflive_CanvasComponent)))
}
function $as_Lnl_amsscala_sjsgameoflive_CanvasComponent(obj) {
  return (($is_Lnl_amsscala_sjsgameoflive_CanvasComponent(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "nl.amsscala.sjsgameoflive.CanvasComponent"))
}
function $isArrayOf_Lnl_amsscala_sjsgameoflive_CanvasComponent(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnl_amsscala_sjsgameoflive_CanvasComponent)))
}
function $asArrayOf_Lnl_amsscala_sjsgameoflive_CanvasComponent(obj, depth) {
  return (($isArrayOf_Lnl_amsscala_sjsgameoflive_CanvasComponent(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnl.amsscala.sjsgameoflive.CanvasComponent;", depth))
}
function $f_Lnl_amsscala_sjsgameoflive_Game__nl$amsscala$sjsgameoflive$Game$$$anonfun$play$4__Lorg_scalajs_dom_raw_KeyboardEvent__scm_Set__O($thiz, e, keysPressed$1) {
  var x1 = $uI(e.keyCode);
  switch (x1) {
    case 37:
    case 39:
    ...
    case 40: {
      ...
      return keysPressed$1.$$plus$eq__O__scm_HashSet(elem);
      break
    }
    default: {
      return (void 0)
...
function $f_Lnl_amsscala_sjsgameoflive_Game__nl$amsscala$sjsgameoflive$Game$$$anonfun$play$5__Lorg_scalajs_dom_raw_KeyboardEvent__scm_Set__scm_Set($thiz, e, keysPressed$1) {
  var elem = $uI(e.keyCode);
  return keysPressed$1.$$minus$eq__O__scm_HashSet(elem)
}
function $f_Lnl_amsscala_sjsgameoflive_Game__nl$amsscala$sjsgameoflive$Game$$$anonfun$play$3__Lorg_scalajs_dom_raw_MouseEvent__V($thiz, e) {
  $m_Lnl_amsscala_sjsgameoflive_LivingWorld$().add__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position__V(new $c_Lnl_amsscala_sjsgameoflive_package$Position().init___O__O__s_math_Numeric($doubleToInt($uD(e.clientX)), $doubleToInt($uD(e.clientY)), $m_s_math_Numeric$IntIsIntegral$()), $as_Lnl_amsscala_sjsgameoflive_Page($thiz).origin__Lnl_amsscala_sjsgameoflive_package$Position())
}
function $f_Lnl_amsscala_sjsgameoflive_Game__gameLoop$1__pLnl_amsscala_sjsgameoflive_Game__sci_Set($thiz) {
  var this$1 = $as_Lnl_amsscala_sjsgameoflive_Page($thiz);
  var gs = $m_Lnl_amsscala_sjsgameoflive_LivingWorld$().tick__sci_Set__sci_Set__sci_Set($m_Lnl_amsscala_sjsgameoflive_LivingWorld$().tick$default$1__sci_Set(), $m_Lnl_amsscala_sjsgameoflive_LivingWorld$().tick$default$2__sci_Set());
  var t = $m_Lnl_amsscala_sjsgameoflive_LivingWorld$().generation$1;
  var lo = t.lo$2;
  var hi = t.hi$2;
  return $f_Lnl_amsscala_sjsgameoflive_Page__render__sci_Set__J__sci_Set(this$1, gs, new $c_sjsr_RuntimeLong().init___I__I(lo, hi))
}
function $f_Lnl_amsscala_sjsgameoflive_Game__play__Lorg_scalajs_dom_raw_HTMLCanvasElement__Z__V($thiz, canvas, headless) {
  var _1 = new $c_scm_HashSet().init___();
  var _2 = $m_Lnl_amsscala_sjsgameoflive_GameState$().apply__Lorg_scalajs_dom_raw_HTMLCanvasElement__s_math_Numeric__Lnl_amsscala_sjsgameoflive_GameState(canvas, $m_s_math_Numeric$LongIsIntegral$());
  var this$4 = _2.pageElements$1;
  $m_sci_Vector$();
  ...
  while (this$5.$$undhasNext$2) {
    ...
    var pg = $as_Lnl_amsscala_sjsgameoflive_CanvasComponent(arg1);
    var this$6 = $as_Lnl_amsscala_sjsgameoflive_Page($thiz);
    var src = pg.src__T();
    b.$$plus$eq__O__scm_Builder($f_Lnl_amsscala_sjsgameoflive_Page__imageFuture__T__s_concurrent_Future(this$6, src))
  };
  $as_sci_Vector(b.result__O());
  var this$7 = $as_Lnl_amsscala_sjsgameoflive_Page($thiz);
  var gs = $m_Lnl_amsscala_sjsgameoflive_LivingWorld$().randomize__sci_Set();
  $f_Lnl_amsscala_sjsgameoflive_Page__render__sci_Set__J__sci_Set(this$7, gs, $m_sjsr_RuntimeLong$().Zero__sjsr_RuntimeLong());
  if ((!headless)) {
    $m_sjs_js_timers_package$().setInterval__D__F0__sjs_js_timers_SetIntervalHandle(300.0, new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(this$2$1) {
      return (function() {
        $f_Lnl_amsscala_sjsgameoflive_Game__gameLoop$1__pLnl_amsscala_sjsgameoflive_Game__sci_Set(this$2$1)
      })
    })($thiz)));
    canvas.onclick = (function(arg$outer) {
      return (function(arg1$2) {
        $f_Lnl_amsscala_sjsgameoflive_Game__nl$amsscala$sjsgameoflive$Game$$$anonfun$play$3__Lorg_scalajs_dom_raw_MouseEvent__V(arg$outer, arg1$2)
      })
    })($thiz);
    $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().addEventListener("keydown", (function(arg$outer$1, keysPressed$1) {
      return (function(arg1$2$1) {
        return $f_Lnl_amsscala_sjsgameoflive_Game__nl$amsscala$sjsgameoflive$Game$$$anonfun$play$4__Lorg_scalajs_dom_raw_KeyboardEvent__scm_Set__O(arg$outer$1, arg1$2$1, keysPressed$1)
      })
    })($thiz, _1), false);
    $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().addEventListener("keyup", (function(arg$outer$2, keysPressed$1$1) {
      return (function(arg1$2$2) {
        return $f_Lnl_amsscala_sjsgameoflive_Game__nl$amsscala$sjsgameoflive$Game$$$anonfun$play$5__Lorg_scalajs_dom_raw_KeyboardEvent__scm_Set__scm_Set(arg$outer$2, arg1$2$2, keysPressed$1$1)
      })
    })($thiz, _1), false)
  }
}
function $f_Lnl_amsscala_sjsgameoflive_Page__nl$amsscala$sjsgameoflive$Page$$postponed__Lorg_scalajs_dom_raw_Node($thiz) {
  ...
  var jsx$5 = $m_Lscalatags_JsDom$all$().cls__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("content", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$4 = $m_Lscalatags_JsDom$all$().style__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("text-align:center; background-color:#3F8630;", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var this$2 = $m_Lscalatags_JsDom$all$();
  var e = $thiz.canvas$1;
  var jsx$3 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$2, e);
  var this$3 = $m_Lscalatags_JsDom$all$();
  var jsx$2 = this$3.a__Lscalatags_JsDom$TypedTag().apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().href__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("http://www.lostdecadegames.com/how-to-make-a-simple-html5-canvas-game/", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().title__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair(new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["This object code is compiled with type parameter ", "."])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$f_Lnl_amsscala_sjsgameoflive_Page__genericDetect__pLnl_amsscala_sjsgameoflive_Page__O__T($thiz, $m_sjsr_RuntimeLong$().Zero__sjsr_RuntimeLong())])), $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("HTML5 Canvas Game of Life"))]));
  $m_Lscalatags_JsDom$all$();
  var jsx$1 = new $c_Lscalatags_JsDom$StringFrag().init___T(" powered by ");
  var this$6 = $m_Lscalatags_JsDom$all$();
  return jsx$7.appendChild(jsx$6.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$5, jsx$4, jsx$3, jsx$2, jsx$1, this$6.a__Lscalatags_JsDom$TypedTag().apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().href__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("http://www.scala-js.org/", $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Scala.js"))]))])).render__Lorg_scalajs_dom_raw_Element())
}
function $f_Lnl_amsscala_sjsgameoflive_Page__$$init$__V($thiz) {
  $thiz.canvas$1 = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("canvas");
  $thiz.nl$amsscala$sjsgameoflive$Page$$ctx$1 = $thiz.canvas$1.getContext("2d");
  $thiz.nl$amsscala$sjsgameoflive$Page$$cellSize$1 = 10;
  $thiz.canvas$1.textContent = "Your browser doesn't support the HTML5 <CANVAS> tag.";
  var cnvs = $thiz.canvas$1;
  var pos = new $c_Lnl_amsscala_sjsgameoflive_package$Position().init___O__O__s_math_Numeric($uD($m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().innerWidth), ((-25.0) + $uD($m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().innerHeight)), $m_s_math_Numeric$DoubleIsFractional$());
  cnvs.width = $uI(pos.x$1);
  cnvs.height = $uI(pos.y$1)
}
function $f_Lnl_amsscala_sjsgameoflive_Page__genericDetect__pLnl_amsscala_sjsgameoflive_Page__O__T($thiz, x) {
  return ($is_sjsr_RuntimeLong(x) ? "Long" : ($isInt(x) ? "Int" : (((typeof x) === "number") ? "Double" : "unknown")))
}
function $f_Lnl_amsscala_sjsgameoflive_Page__canvasDim__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lnl_amsscala_sjsgameoflive_package$Position($thiz, cnvs) {
  return new $c_Lnl_amsscala_sjsgameoflive_package$Position().init___O__O__s_math_Numeric($uI(cnvs.width), $uI(cnvs.height), $m_s_math_Numeric$IntIsIntegral$())
}
function $f_Lnl_amsscala_sjsgameoflive_Page__drawCells$1__pLnl_amsscala_sjsgameoflive_Page__sci_Set__V($thiz, cells) {
  $thiz.nl$amsscala$sjsgameoflive$Page$$ctx$1.fillStyle = "white";
  cells.foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this) {
    return (function(cell$2) {
      var cell = $as_Lnl_amsscala_sjsgameoflive_package$Position(cell$2);
      var pos = $this.origin__Lnl_amsscala_sjsgameoflive_package$Position().$$plus__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position(cell.$$times__O__Lnl_amsscala_sjsgameoflive_package$Position($this.nl$amsscala$sjsgameoflive$Page$$cellSize$1));
      $this.nl$amsscala$sjsgameoflive$Page$$ctx$1.rect($uI(pos.x$1), $uI(pos.y$1), $this.nl$amsscala$sjsgameoflive$Page$$cellSize$1, $this.nl$amsscala$sjsgameoflive$Page$$cellSize$1)
    })
  })($thiz)))
}
function $f_Lnl_amsscala_sjsgameoflive_Page__render__sci_Set__J__sci_Set($thiz, gs, generation) {
  $thiz.nl$amsscala$sjsgameoflive$Page$$postponed__Lorg_scalajs_dom_raw_Node();
  $thiz.nl$amsscala$sjsgameoflive$Page$$ctx$1.beginPath();
  $thiz.nl$amsscala$sjsgameoflive$Page$$ctx$1.strokeStyle = "black";
  var end = ($uI($thiz.origin__Lnl_amsscala_sjsgameoflive_package$Position().x$1) << 1);
  var isEmpty$4 = (end < 0);
  var step = $thiz.nl$amsscala$sjsgameoflive$Page$$cellSize$1;
  var isEmpty$4$1 = (((end < 0) && (step > 0)) || ((end > 0) && (step < 0)));
  if ((step === 0)) {
  ...
  if (isEmpty$4$1) {
    ...
    this$6.divideImpl__I__I__I__I__I(end, hi$2, step, hi$3)
  };
  switch (step) {
    case 1: {
      var scala$collection$immutable$Range$$lastElement$4 = end;
      break
    }
    case (-1): {
      var scala$collection$immutable$Range$$lastElement$4 = end;
    ...
    default: {
      ...
      var lo$3 = this$8.remainderImpl__I__I__I__I__I(end, hi$6, step, hi$7);
      var scala$collection$immutable$Range$$lastElement$4 = ((lo$3 !== 0) ? ((end - lo$3) | 0) : end)
    }
  };
  if ((!isEmpty$4$1)) {
    var i = 0;
    while (true) {
      var v1 = i;
      var end$1 = ($uI($thiz.origin__Lnl_amsscala_sjsgameoflive_package$Position().y$1) << 1);
      var isEmpty$4$2 = (end$1 < 0);
      var step$1 = $thiz.nl$amsscala$sjsgameoflive$Page$$cellSize$1;
      var isEmpty$4$3 = (((end$1 < 0) && (step$1 > 0)) || ((end$1 > 0) && (step$1 < 0)));
      if ((step$1 === 0)) {
        throw new $c_jl_IllegalArgumentException().init___T("step cannot be 0.")
      };
      if (isEmpty$4$3) {
        ...
        this$13.divideImpl__I__I__I__I__I(end$1, hi$11, step$1, hi$12)
      };
      switch (step$1) {
        case 1: {
          var scala$collection$immutable$Range$$lastElement$4$1 = end$1;
          break
        }
        case (-1): {
          var scala$collection$immutable$Range$$lastElement$4$1 = end$1;
        ...
        default: {
          ...
          var lo$7 = this$15.remainderImpl__I__I__I__I__I(end$1, hi$15, step$1, hi$16);
          var scala$collection$immutable$Range$$lastElement$4$1 = ((lo$7 !== 0) ? ((end$1 - lo$7) | 0) : end$1)
        }
      };
      if ((!isEmpty$4$3)) {
        var i$1 = 0;
        while (true) {
          var v1$1 = i$1;
          $thiz.nl$amsscala$sjsgameoflive$Page$$ctx$1.moveTo(0.0, v1$1);
          $thiz.nl$amsscala$sjsgameoflive$Page$$ctx$1.lineTo($uI($thiz.nl$amsscala$sjsgameoflive$Page$$ctx$1.canvas.width), v1$1);
          $thiz.nl$amsscala$sjsgameoflive$Page$$ctx$1.moveTo(v1, 0.0);
          $thiz.nl$amsscala$sjsgameoflive$Page$$ctx$1.lineTo(v1, $uI($thiz.nl$amsscala$sjsgameoflive$Page$$ctx$1.canvas.height));
  ...
  var jsx$2 = $m_Lnl_amsscala_sjsgameoflive_LivingWorld$();
  var jsx$1 = $m_Lnl_amsscala_sjsgameoflive_LivingWorld$();
  var cnvs = $thiz.canvas$1;
  var cellInWondow = jsx$2.containedInRect__sci_Set__Lnl_amsscala_sjsgameoflive_package$Position__sci_Set(gs, jsx$1.convertPx2CellCoord__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position($f_Lnl_amsscala_sjsgameoflive_Page__canvasDim__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lnl_amsscala_sjsgameoflive_package$Position($thiz, cnvs), $thiz.origin__Lnl_amsscala_sjsgameoflive_package$Position()));
  $f_Lnl_amsscala_sjsgameoflive_Page__drawCells$1__pLnl_amsscala_sjsgameoflive_Page__sci_Set__V($thiz, cellInWondow);
  $thiz.nl$amsscala$sjsgameoflive$Page$$ctx$1.clearRect(0.0, 0.0, $uI($thiz.canvas$1.width), $uI($thiz.canvas$1.height));
  $thiz.nl$amsscala$sjsgameoflive$Page$$ctx$1.fill();
  $thiz.nl$amsscala$sjsgameoflive$Page$$ctx$1.stroke();
  $thiz.nl$amsscala$sjsgameoflive$Page$$ctx$1.fillStyle = "orange";
  $thiz.nl$amsscala$sjsgameoflive$Page$$ctx$1.font = "24px Helvetica";
  $thiz.nl$amsscala$sjsgameoflive$Page$$ctx$1.textAlign = "left";
  $thiz.nl$amsscala$sjsgameoflive$Page$$ctx$1.textBaseline = "top";
  $thiz.toLocaleString("nl-NL", {});
  var total = gs.size__I();
  var visible = $m_Lnl_amsscala_sjsgameoflive_LivingWorld$().containedInRect__sci_Set__Lnl_amsscala_sjsgameoflive_package$Position__sci_Set(gs, new $c_Lnl_amsscala_sjsgameoflive_package$Position().init___O__O__s_math_Numeric(52, 26, $m_s_math_Numeric$IntIsIntegral$())).size__I();
  var jsx$5 = $thiz.nl$amsscala$sjsgameoflive$Page$$ctx$1;
  var arg$macro$2 = generation.toLocaleString("nl-NL", {});
  var arg$macro$3 = total.toLocaleString("nl-NL", {});
  var arg$macro$4 = visible.toLocaleString("nl-NL", {});
  var this$21 = new $c_sci_StringOps().init___T("Generation %10s. Population %5s, visible: %5s");
  var array = [arg$macro$2, arg$macro$3, arg$macro$4];
  ...
  while ((i$2 < len)) {
    ...
    var elem = $f_sci_StringLike__unwrapArg__psci_StringLike__O__O(this$21, arg1);
    array$1.push(elem);
    i$2 = ((1 + i$2) | 0)
  };
  ...
  while ((i$3 < end$2)) {
    var jsx$3 = j;
    var index$1 = i$3;
    result.u[jsx$3] = array$1[index$1];
    i$3 = ((1 + i$3) | 0);
    j = ((1 + j) | 0)
  };
  jsx$5.fillText(jsx$4.format__T__AO__T($$this, result), 32.0, 32.0);
  return gs
}
function $f_Lnl_amsscala_sjsgameoflive_Page__origin__Lnl_amsscala_sjsgameoflive_package$Position($thiz) {
  var cnvs = $thiz.canvas$1;
  var org = $f_Lnl_amsscala_sjsgameoflive_Page__center__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lnl_amsscala_sjsgameoflive_package$Position($thiz, cnvs);
  return new $c_Lnl_amsscala_sjsgameoflive_package$Position().init___O__O__s_math_Numeric((($uI(org.x$1) - (($uI(org.x$1) % $thiz.nl$amsscala$sjsgameoflive$Page$$cellSize$1) | 0)) | 0), (($uI(org.y$1) - (($uI(org.y$1) % $thiz.nl$amsscala$sjsgameoflive$Page$$cellSize$1) | 0)) | 0), $m_s_math_Numeric$IntIsIntegral$())
}
function $f_Lnl_amsscala_sjsgameoflive_Page__imageFuture__T__s_concurrent_Future($thiz, src) {
  var img = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("img");
  img.setAttribute("crossOrigin", "anonymous");
  img.src = src;
  if ($uZ(img.complete)) {
    return $m_s_concurrent_Future$().successful__O__s_concurrent_Future(img)
  } else {
    var p = new $c_s_concurrent_impl_Promise$DefaultPromise().init___();
    img.onload = (function(arg$outer, img$1, p$1) {
      return (function(arg1$2) {
        return $f_s_concurrent_Promise__success__O__s_concurrent_Promise(p$1, img$1)
      })
    })($thiz, img, p);
    return p
  }
}
function $f_Lnl_amsscala_sjsgameoflive_Page__center__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lnl_amsscala_sjsgameoflive_package$Position($thiz, cnvs) {
  return new $c_Lnl_amsscala_sjsgameoflive_package$Position().init___O__O__s_math_Numeric((($uI($thiz.canvas$1.width) / 2) | 0), (($uI($thiz.canvas$1.height) / 2) | 0), $m_s_math_Numeric$IntIsIntegral$())
}
function $is_Lnl_amsscala_sjsgameoflive_Page(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnl_amsscala_sjsgameoflive_Page)))
}
function $as_Lnl_amsscala_sjsgameoflive_Page(obj) {
  return (($is_Lnl_amsscala_sjsgameoflive_Page(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "nl.amsscala.sjsgameoflive.Page"))
}
function $isArrayOf_Lnl_amsscala_sjsgameoflive_Page(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnl_amsscala_sjsgameoflive_Page)))
}
function $asArrayOf_Lnl_amsscala_sjsgameoflive_Page(obj, depth) {
  return (($isArrayOf_Lnl_amsscala_sjsgameoflive_Page(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnl.amsscala.sjsgameoflive.Page;", depth))
}
...
/** @constructor */
function $c_Lnl_amsscala_sjsgameoflive_GameState() {
  $c_O.call(this);
  this.canvas$1 = null;
  this.pageElements$1 = null;
  this.isNewGame$1 = false;
  this.isGameOver$1 = false;
  this.monstersCaught$1 = 0;
  this.monstersHitTxt$1 = null;
  this.$$undgameOverTxt$1 = null;
  this.$$undexplainTxt$1 = null;
  this.evidence$1$1 = null
}
$c_Lnl_amsscala_sjsgameoflive_GameState.prototype = new $h_O();
$c_Lnl_amsscala_sjsgameoflive_GameState.prototype.constructor = $c_Lnl_amsscala_sjsgameoflive_GameState;
/** @constructor */
function $h_Lnl_amsscala_sjsgameoflive_GameState() {
  /*<skip>*/
}
$h_Lnl_amsscala_sjsgameoflive_GameState.prototype = $c_Lnl_amsscala_sjsgameoflive_GameState.prototype;
$c_Lnl_amsscala_sjsgameoflive_GameState.prototype.equals__O__Z = (function(that) {
  if ($is_Lnl_amsscala_sjsgameoflive_GameState(that)) {
    var x2 = $as_Lnl_amsscala_sjsgameoflive_GameState(that);
    var x = this.pageElements$1;
    var x$2 = x2.pageElements$1;
    return ((x === null) ? (x$2 === null) : $f_sc_GenSeqLike__equals__O__Z(x, x$2))
  } else {
    return false
  }
});
$c_Lnl_amsscala_sjsgameoflive_GameState.prototype.toString__T = (function() {
  return new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["", " ", " isNew:", " ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lnl_amsscala_sjsgameoflive_package$Position().init___O__O__s_math_Numeric($uI(this.canvas$1.width), $uI(this.canvas$1.height), $m_s_math_Numeric$IntIsIntegral$()), this.pageElements$1, this.isNewGame$1, this.monstersHitTxt$1]))
});
$c_Lnl_amsscala_sjsgameoflive_GameState.prototype.init___Lorg_scalajs_dom_raw_HTMLCanvasElement__sci_Vector__Z__Z__I__T__F0__F0__s_math_Numeric = (function(canvas, pageElements, isNewGame, isGameOver, monstersCaught, monstersHitTxt, _gameOverTxt, _explainTxt, evidence$1) {
  this.canvas$1 = canvas;
  this.pageElements$1 = pageElements;
  this.isNewGame$1 = isNewGame;
  this.isGameOver$1 = isGameOver;
  this.monstersCaught$1 = monstersCaught;
  this.monstersHitTxt$1 = monstersHitTxt;
  this.$$undgameOverTxt$1 = _gameOverTxt;
  this.$$undexplainTxt$1 = _explainTxt;
  this.evidence$1$1 = evidence$1;
  var requirement = ((((pageElements.length__I() === 3) && ($as_Lnl_amsscala_sjsgameoflive_Playground(this.pageElements$1.head__O()) !== null)) && ($as_Lnl_amsscala_sjsgameoflive_Monster(this.pageElements$1.apply__I__O(1)) !== null)) && ($as_Lnl_amsscala_sjsgameoflive_Hero(this.pageElements$1.last__O()) !== null));
  if ((!requirement)) {
    throw new $c_jl_IllegalArgumentException().init___T("requirement failed: Page elements are not listed well.")
  };
  return this
});
function $is_Lnl_amsscala_sjsgameoflive_GameState(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnl_amsscala_sjsgameoflive_GameState)))
}
function $as_Lnl_amsscala_sjsgameoflive_GameState(obj) {
  return (($is_Lnl_amsscala_sjsgameoflive_GameState(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "nl.amsscala.sjsgameoflive.GameState"))
}
function $isArrayOf_Lnl_amsscala_sjsgameoflive_GameState(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnl_amsscala_sjsgameoflive_GameState)))
}
function $asArrayOf_Lnl_amsscala_sjsgameoflive_GameState(obj, depth) {
  return (($isArrayOf_Lnl_amsscala_sjsgameoflive_GameState(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnl.amsscala.sjsgameoflive.GameState;", depth))
}
var $d_Lnl_amsscala_sjsgameoflive_GameState = new $TypeData().initClass({
  Lnl_amsscala_sjsgameoflive_GameState: 0
}, false, "nl.amsscala.sjsgameoflive.GameState", {
  Lnl_amsscala_sjsgameoflive_GameState: 1,
  O: 1
});
$c_Lnl_amsscala_sjsgameoflive_GameState.prototype.$classData = $d_Lnl_amsscala_sjsgameoflive_GameState;
/** @constructor */
function $c_Lnl_amsscala_sjsgameoflive_GameState$() {
  $c_O.call(this)
}
...
$h_Lnl_amsscala_sjsgameoflive_GameState$.prototype = $c_Lnl_amsscala_sjsgameoflive_GameState$.prototype;
$c_Lnl_amsscala_sjsgameoflive_GameState$.prototype.init___ = (function() {
  return this
});
$c_Lnl_amsscala_sjsgameoflive_GameState$.prototype.apply__Lorg_scalajs_dom_raw_HTMLCanvasElement__s_math_Numeric__Lnl_amsscala_sjsgameoflive_GameState = (function(canvas, evidence$2) {
  var this$3 = $m_s_package$().Vector$1;
  var jsx$1 = new $c_Lnl_amsscala_sjsgameoflive_Playground().init___Lnl_amsscala_sjsgameoflive_package$Position__Lorg_scalajs_dom_raw_HTMLImageElement(new $c_Lnl_amsscala_sjsgameoflive_package$Position().init___O__O__s_math_Numeric(0, 0, $m_s_math_Numeric$IntIsIntegral$()), null);
  var randPos = $m_Lnl_amsscala_sjsgameoflive_Monster$().randomPosition__Lorg_scalajs_dom_raw_HTMLCanvasElement__s_math_Numeric__Lnl_amsscala_sjsgameoflive_package$Position(canvas, evidence$2);
  var array = [jsx$1, new $c_Lnl_amsscala_sjsgameoflive_Monster().init___Lnl_amsscala_sjsgameoflive_package$Position__Lorg_scalajs_dom_raw_HTMLImageElement(randPos, null), $m_Lnl_amsscala_sjsgameoflive_Hero$().apply__Lorg_scalajs_dom_raw_HTMLCanvasElement__s_math_Numeric__Lnl_amsscala_sjsgameoflive_Hero(canvas, evidence$2)];
  if (($uI(array.length) === 0)) {
    var jsx$2 = this$3.NIL$6
  } else {
    ...
    var jsx$2 = b.result__sci_Vector()
  };
  return new $c_Lnl_amsscala_sjsgameoflive_GameState().init___Lorg_scalajs_dom_raw_HTMLCanvasElement__sci_Vector__Z__Z__I__T__F0__F0__s_math_Numeric(canvas, jsx$2, true, false, 0, $m_Lnl_amsscala_sjsgameoflive_GameState$().monsterText__I__T(0), new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this) {
    return (function() {
      return "Game Over?"
    })
  })(this)), new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(this$2$1) {
    return (function() {
      return "Use the arrow keys to\nattack the hidden monster."
    })
  })(this)), evidence$2)
});
$c_Lnl_amsscala_sjsgameoflive_GameState$.prototype.monsterText__I__T = (function(score) {
  var this$1 = new $c_sci_StringOps().init___T("Goblins caught: %03d");
  var array = [score];
...
$c_Lnl_amsscala_sjsgameoflive_GameState$.prototype.$classData = $d_Lnl_amsscala_sjsgameoflive_GameState$;
var $n_Lnl_amsscala_sjsgameoflive_GameState$ = (void 0);
function $m_Lnl_amsscala_sjsgameoflive_GameState$() {
  if ((!$n_Lnl_amsscala_sjsgameoflive_GameState$)) {
    $n_Lnl_amsscala_sjsgameoflive_GameState$ = new $c_Lnl_amsscala_sjsgameoflive_GameState$().init___()
  };
  return $n_Lnl_amsscala_sjsgameoflive_GameState$
}
/** @constructor */
function $c_Lnl_amsscala_sjsgameoflive_Hero$() {
  $c_O.call(this);
  this.x$1$1 = null;
  this.pxSize$1 = 0;
  this.speed$1 = 0
}
$c_Lnl_amsscala_sjsgameoflive_Hero$.prototype = new $h_O();
$c_Lnl_amsscala_sjsgameoflive_Hero$.prototype.constructor = $c_Lnl_amsscala_sjsgameoflive_Hero$;
/** @constructor */
function $h_Lnl_amsscala_sjsgameoflive_Hero$() {
  /*<skip>*/
}
$h_Lnl_amsscala_sjsgameoflive_Hero$.prototype = $c_Lnl_amsscala_sjsgameoflive_Hero$.prototype;
$c_Lnl_amsscala_sjsgameoflive_Hero$.prototype.init___ = (function() {
  $n_Lnl_amsscala_sjsgameoflive_Hero$ = this;
  this.x$1$1 = new $c_s_Tuple2$mcII$sp().init___I__I(32, 256);
  this.pxSize$1 = this.x$1$1.$$und1$mcI$sp__I();
  this.speed$1 = this.x$1$1.$$und2$mcI$sp__I();
  return this
});
$c_Lnl_amsscala_sjsgameoflive_Hero$.prototype.apply__Lorg_scalajs_dom_raw_HTMLCanvasElement__s_math_Numeric__Lnl_amsscala_sjsgameoflive_Hero = (function(canvas, evidence$5) {
  $m_Lnl_amsscala_sjsgameoflive_Hero$();
  var this$1 = $m_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$();
  var pos = $f_Lnl_amsscala_sjsgameoflive_Page__center__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lnl_amsscala_sjsgameoflive_package$Position(this$1, canvas);
  return new $c_Lnl_amsscala_sjsgameoflive_Hero().init___Lnl_amsscala_sjsgameoflive_package$Position__Lorg_scalajs_dom_raw_HTMLImageElement__s_math_Numeric(pos, null, evidence$5)
});
var $d_Lnl_amsscala_sjsgameoflive_Hero$ = new $TypeData().initClass({
  Lnl_amsscala_sjsgameoflive_Hero$: 0
}, false, "nl.amsscala.sjsgameoflive.Hero$", {
  Lnl_amsscala_sjsgameoflive_Hero$: 1,
  O: 1
});
$c_Lnl_amsscala_sjsgameoflive_Hero$.prototype.$classData = $d_Lnl_amsscala_sjsgameoflive_Hero$;
var $n_Lnl_amsscala_sjsgameoflive_Hero$ = (void 0);
function $m_Lnl_amsscala_sjsgameoflive_Hero$() {
  if ((!$n_Lnl_amsscala_sjsgameoflive_Hero$)) {
    $n_Lnl_amsscala_sjsgameoflive_Hero$ = new $c_Lnl_amsscala_sjsgameoflive_Hero$().init___()
  };
  return $n_Lnl_amsscala_sjsgameoflive_Hero$
}
/** @constructor */
function $c_Lnl_amsscala_sjsgameoflive_LivingWorld$() {
  $c_O.call(this);
  this.r$1 = null;
  this.generation$1 = $m_sjsr_RuntimeLong$().Zero__sjsr_RuntimeLong();
  this.livingWorld$1 = null;
  this.bitmap$0$1 = false
}
$c_Lnl_amsscala_sjsgameoflive_LivingWorld$.prototype = new $h_O();
$c_Lnl_amsscala_sjsgameoflive_LivingWorld$.prototype.constructor = $c_Lnl_amsscala_sjsgameoflive_LivingWorld$;
/** @constructor */
function $h_Lnl_amsscala_sjsgameoflive_LivingWorld$() {
  /*<skip>*/
}
$h_Lnl_amsscala_sjsgameoflive_LivingWorld$.prototype = $c_Lnl_amsscala_sjsgameoflive_LivingWorld$.prototype;
$c_Lnl_amsscala_sjsgameoflive_LivingWorld$.prototype.init___ = (function() {
  $n_Lnl_amsscala_sjsgameoflive_LivingWorld$ = this;
  this.generation$1 = $m_sjsr_RuntimeLong$().Zero__sjsr_RuntimeLong();
  this.livingWorld$1 = $m_sci_Set$EmptySet$();
  return this
});
$c_Lnl_amsscala_sjsgameoflive_LivingWorld$.prototype.survivors$1__p1__sci_Set__sci_Map__sci_Set = (function(rulestringS$1, neighbors$1) {
  return $as_sci_Set(this.livingWorld$1.filter__F1__O(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, rulestringS$1$1, neighbors$1$1) {
    return (function(x0$3$2) {
      var x0$3 = $as_Lnl_amsscala_sjsgameoflive_package$Position(x0$3$2);
      var x1 = neighbors$1$1.get__O__s_Option(x0$3);
      if ($is_s_Some(x1)) {
        var x2 = $as_s_Some(x1);
        var v = x2.value$2;
        var jsx$1 = v
      ...
      return rulestringS$1$1.contains__O__Z(jsx$1)
    })
  })(this, rulestringS$1, neighbors$1))))
});
$c_Lnl_amsscala_sjsgameoflive_LivingWorld$.prototype.tick$default$2__sci_Set = (function() {
  var array = [2, 3];
  if (($uI(array.length) === 0)) {
...
$c_Lnl_amsscala_sjsgameoflive_LivingWorld$.prototype.add__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position__V = (function(clickPos, origin) {
  this.livingWorld$1 = $as_sci_Set(this.livingWorld$1.$$plus__O__sc_Set(this.convertPx2CellCoord__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position(clickPos, origin)))
});
$c_Lnl_amsscala_sjsgameoflive_LivingWorld$.prototype.tick$default$1__sci_Set = (function() {
  var array = [3];
  if (($uI(array.length) === 0)) {
    var jsx$1 = $m_sci_Set$EmptySet$()
  } else {
...
$c_Lnl_amsscala_sjsgameoflive_LivingWorld$.prototype.randomize__sci_Set = (function() {
  $m_sci_IndexedSeq$();
  $m_sc_IndexedSeq$();
  $m_sci_IndexedSeq$();
  $m_sci_Vector$();
  ...
  while (true) {
    var arg1 = i;
    var this$7 = this.r__s_util_Random$();
    var jsx$1 = this$7.self$1.nextInt__I__I(160);
    var this$8 = this.r__s_util_Random$();
    var elem = new $c_Lnl_amsscala_sjsgameoflive_package$Position().init___O__O__s_math_Numeric((((-80) + jsx$1) | 0), (((-40) + this$8.self$1.nextInt__I__I(80)) | 0), $m_s_math_Numeric$IntIsIntegral$());
  ...
  var cbf = new $c_scg_GenSetFactory$$anon$1().init___scg_GenSetFactory(this$10);
  this.livingWorld$1 = $as_sci_Set($f_sc_TraversableLike__to__scg_CanBuildFrom__O(this$9, cbf));
  return this.livingWorld$1
});
$c_Lnl_amsscala_sjsgameoflive_LivingWorld$.prototype.r$lzycompute__p1__s_util_Random$ = (function() {
  if ((!this.bitmap$0$1)) {
    this.r$1 = $m_s_util_Random$();
    this.bitmap$0$1 = true
  };
  return this.r$1
});
$c_Lnl_amsscala_sjsgameoflive_LivingWorld$.prototype.r__s_util_Random$ = (function() {
  return ((!this.bitmap$0$1) ? this.r$lzycompute__p1__s_util_Random$() : this.r$1)
});
$c_Lnl_amsscala_sjsgameoflive_LivingWorld$.prototype.tick__sci_Set__sci_Set__sci_Set = (function(rulestringB, rulestringS) {
  var t = this.generation$1;
  var lo = t.lo$2;
  var hi = t.hi$2;
  var assumption = (!((lo === 2147483647) && (hi === 0)));
  if ((!assumption)) {
    throw new $c_jl_AssertionError().init___O("assumption failed: Generations outnumbered")
  };
  var b = this.generation$1;
  var bhi = b.hi$2;
  var lo$1 = ((1 + b.lo$2) | 0);
  var hi$1 = ((lo$1 === 0) ? ((1 + bhi) | 0) : bhi);
  this.generation$1 = new $c_sjsr_RuntimeLong().init___I__I(lo$1, hi$1);
  var this$3 = this.livingWorld$1;
  var this$4 = $m_sci_List$();
  var cbf = this$4.ReusableCBFInstance$2;
  var this$6 = $as_sci_List($f_sc_TraversableLike__to__scg_CanBuildFrom__O(this$3, cbf));
  var f = (function(this$2$1) {
    return (function(x$1$2) {
      var x$1 = $as_Lnl_amsscala_sjsgameoflive_package$Position(x$1$2);
      return x$1.mooreNeighborHood__I__sci_Set(1)
    })
  })(this);
  ...
  if ((bf === $m_sci_List$().ReusableCBFInstance$2)) {
    if ((this$6 === $m_sci_Nil$())) {
      ...
      while ((rest !== $m_sci_Nil$())) {
        ...
        $as_sc_GenTraversableOnce(f(arg1)).seq__sc_TraversableOnce().foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, found$1, h$1, t$2) {
          return (function(b$2) {
            if ((!found$1.elem$1)) {
  ...
  var this$14 = $as_sc_TraversableLike(jsx$1);
  var f$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$3$1) {
    return (function(x$2) {
      var x = $as_Lnl_amsscala_sjsgameoflive_package$Position(x$2);
      return x
    })
  })(this));
  var this$16 = $f_sc_TraversableLike__groupBy__F1__sci_Map(this$14, f$1);
  var f$2 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$4$1) {
    return (function(x0$1$2) {
      var x0$1 = $as_T2(x0$1$2);
      if ((x0$1 !== null)) {
        var cell = $as_Lnl_amsscala_sjsgameoflive_package$Position(x0$1.$$und1__O());
        var list = $as_sci_List(x0$1.$$und2__O());
        return new $c_T2().init___O__O(cell, $f_sc_LinearSeqOptimized__length__I(list))
      } else {
  ...
  var bf$1 = new $c_scg_GenMapFactory$MapCanBuildFrom().init___scg_GenMapFactory(this$15);
  var neighbors = $as_sci_Map($f_sc_TraversableLike__map__F1__scg_CanBuildFrom__O(this$16, f$2, bf$1));
  this.livingWorld$1 = $as_sci_Set(this.survivors$1__p1__sci_Set__sci_Map__sci_Set(rulestringS, neighbors).$$plus$plus__sc_GenTraversableOnce__sc_Set(this.reproduces$1__p1__sci_Set__sci_Map__sci_Set(rulestringB, neighbors)));
  return this.livingWorld$1
});
$c_Lnl_amsscala_sjsgameoflive_LivingWorld$.prototype.containedInRect__sci_Set__Lnl_amsscala_sjsgameoflive_package$Position__sci_Set = (function(gs, rect) {
  return $as_sci_Set(gs.filter__F1__O(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, rect$1) {
    return (function(aa$2) {
      var aa = $as_Lnl_amsscala_sjsgameoflive_package$Position(aa$2);
      return aa.areTouching__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position__Z(new $c_Lnl_amsscala_sjsgameoflive_package$Position().init___O__O__s_math_Numeric(0, 0, $m_s_math_Numeric$IntIsIntegral$()), rect$1)
    })
  })(this, rect))))
});
$c_Lnl_amsscala_sjsgameoflive_LivingWorld$.prototype.convertPx2CellCoord__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position = (function(clickPos, origin) {
  var centered = clickPos.$$minus__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position(origin.$$plus__O__Lnl_amsscala_sjsgameoflive_package$Position(5));
  var x = ($uI(centered.x$1) / 10.0);
  ...
  var x$2 = new $c_Lnl_amsscala_sjsgameoflive_package$Position().init___O__O__s_math_Numeric(lo, lo$1, $m_s_math_Numeric$IntIsIntegral$());
  ...
  var x$3 = ($uI(centered.x$1) / 10.0);
  var this$18 = $m_sjsr_RuntimeLong$();
  var value$2 = $uD($g.Math.round(x$3));
  var lo$2 = this$18.scala$scalajs$runtime$RuntimeLong$$fromDoubleImpl__D__I(value$2);
  var x$4 = ($uI(centered.y$1) / 10.0);
  var this$23 = $m_sjsr_RuntimeLong$();
  var value$3 = $uD($g.Math.round(x$4));
  var lo$3 = this$23.scala$scalajs$runtime$RuntimeLong$$fromDoubleImpl__D__I(value$3);
  return new $c_Lnl_amsscala_sjsgameoflive_package$Position().init___O__O__s_math_Numeric(lo$2, lo$3, $m_s_math_Numeric$IntIsIntegral$())
});
$c_Lnl_amsscala_sjsgameoflive_LivingWorld$.prototype.reproduces$1__p1__sci_Set__sci_Map__sci_Set = (function(rulestringB$1, neighbors$1) {
  var this$1 = $as_sci_MapLike(neighbors$1.filter__F1__O(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, rulestringB$1$1) {
    return (function(x0$2$2) {
      var x0$2 = $as_T2(x0$2$2);
      if ((x0$2 !== null)) {
        var n = x0$2.$$und2$mcI$sp__I();
        return rulestringB$1$1.contains__O__Z(n)
      } else {
        throw new $c_s_MatchError().init___O(x0$2)
      }
    })
  })(this, rulestringB$1))));
  return new $c_sci_MapLike$ImmutableDefaultKeySet().init___sci_MapLike(this$1)
});
var $d_Lnl_amsscala_sjsgameoflive_LivingWorld$ = new $TypeData().initClass({
  Lnl_amsscala_sjsgameoflive_LivingWorld$: 0
}, false, "nl.amsscala.sjsgameoflive.LivingWorld$", {
  Lnl_amsscala_sjsgameoflive_LivingWorld$: 1,
  O: 1
});
$c_Lnl_amsscala_sjsgameoflive_LivingWorld$.prototype.$classData = $d_Lnl_amsscala_sjsgameoflive_LivingWorld$;
var $n_Lnl_amsscala_sjsgameoflive_LivingWorld$ = (void 0);
function $m_Lnl_amsscala_sjsgameoflive_LivingWorld$() {
  if ((!$n_Lnl_amsscala_sjsgameoflive_LivingWorld$)) {
    $n_Lnl_amsscala_sjsgameoflive_LivingWorld$ = new $c_Lnl_amsscala_sjsgameoflive_LivingWorld$().init___()
  };
  return $n_Lnl_amsscala_sjsgameoflive_LivingWorld$
}
/** @constructor */
function $c_Lnl_amsscala_sjsgameoflive_Monster$() {
  $c_O.call(this)
}
$c_Lnl_amsscala_sjsgameoflive_Monster$.prototype = new $h_O();
$c_Lnl_amsscala_sjsgameoflive_Monster$.prototype.constructor = $c_Lnl_amsscala_sjsgameoflive_Monster$;
/** @constructor */
function $h_Lnl_amsscala_sjsgameoflive_Monster$() {
  /*<skip>*/
}
$h_Lnl_amsscala_sjsgameoflive_Monster$.prototype = $c_Lnl_amsscala_sjsgameoflive_Monster$.prototype;
$c_Lnl_amsscala_sjsgameoflive_Monster$.prototype.init___ = (function() {
  return this
});
$c_Lnl_amsscala_sjsgameoflive_Monster$.prototype.randomPosition__Lorg_scalajs_dom_raw_HTMLCanvasElement__s_math_Numeric__Lnl_amsscala_sjsgameoflive_package$Position = (function(canvas, evidence$3) {
  var dim = $uI(canvas.width);
  var jsx$2 = $uD($g.Math.random());
  var jsx$1 = $m_Lnl_amsscala_sjsgameoflive_Hero$().pxSize$1;
  var dim$1 = $uI(canvas.height);
  return new $c_Lnl_amsscala_sjsgameoflive_package$Position().init___O__O__s_math_Numeric($doubleToInt((jsx$2 * ((dim - jsx$1) | 0))), $doubleToInt(($uD($g.Math.random()) * ((dim$1 - $m_Lnl_amsscala_sjsgameoflive_Hero$().pxSize$1) | 0))), $m_s_math_Numeric$IntIsIntegral$())
});
var $d_Lnl_amsscala_sjsgameoflive_Monster$ = new $TypeData().initClass({
  Lnl_amsscala_sjsgameoflive_Monster$: 0
}, false, "nl.amsscala.sjsgameoflive.Monster$", {
  Lnl_amsscala_sjsgameoflive_Monster$: 1,
  O: 1
});
$c_Lnl_amsscala_sjsgameoflive_Monster$.prototype.$classData = $d_Lnl_amsscala_sjsgameoflive_Monster$;
var $n_Lnl_amsscala_sjsgameoflive_Monster$ = (void 0);
function $m_Lnl_amsscala_sjsgameoflive_Monster$() {
  if ((!$n_Lnl_amsscala_sjsgameoflive_Monster$)) {
    $n_Lnl_amsscala_sjsgameoflive_Monster$ = new $c_Lnl_amsscala_sjsgameoflive_Monster$().init___()
  };
  return $n_Lnl_amsscala_sjsgameoflive_Monster$
}
/** @constructor */
...
$c_s_math_Numeric$Ops.prototype.$$minus__O__O = (function(rhs) {
  return this.$$outer$1.minus__O__O__O(this.lhs$1, rhs)
});
var $d_s_math_Numeric$Ops = new $TypeData().initClass({
  s_math_Numeric$Ops: 0
}, false, "scala.math.Numeric$Ops", {
  s_math_Numeric$Ops: 1,
  O: 1
});
$c_s_math_Numeric$Ops.prototype.$classData = $d_s_math_Numeric$Ops;
/** @constructor */
...
$c_s_math_Ordering$Ops.prototype.$$less$eq__O__Z = (function(rhs) {
  return this.$$outer$1.lteq__O__O__Z(this.lhs$1, rhs)
});
...
function $f_scm_FlatHashTable__removeElem__O__Z($thiz, elem) {
  ...
  while ((curEntry !== null)) {
    if ($m_sr_BoxesRunTime$().equals__O__O__Z(curEntry, removalEntry)) {
      ...
      while (($thiz.table$5.u[h1] !== null)) {
        var hcode$1 = $objectHashCode($thiz.table$5.u[h1]);
        ...
        if (jsx$1) {
          $thiz.table$5.u[h0] = $thiz.table$5.u[h1];
          h0 = h1
        };
        h1 = ((((1 + h1) | 0) % $thiz.table$5.u.length) | 0)
      };
      $thiz.table$5.u[h0] = null;
      $thiz.tableSize$5 = (((-1) + $thiz.tableSize$5) | 0);
      var h$1 = h0;
...
$h_Lnl_amsscala_sjsgameoflive_Hero.prototype = $c_Lnl_amsscala_sjsgameoflive_Hero.prototype;
$c_Lnl_amsscala_sjsgameoflive_Hero.prototype.equals__O__Z = (function(that) {
  return $f_Lnl_amsscala_sjsgameoflive_CanvasComponent__equals__O__Z(this, that)
});
$c_Lnl_amsscala_sjsgameoflive_Hero.prototype.toString__T = (function() {
  return $f_Lnl_amsscala_sjsgameoflive_CanvasComponent__toString__T(this)
});
$c_Lnl_amsscala_sjsgameoflive_Hero.prototype.init___Lnl_amsscala_sjsgameoflive_package$Position__Lorg_scalajs_dom_raw_HTMLImageElement__s_math_Numeric = (function(pos, img, evidence$4) {
  this.pos$1 = pos;
  this.img$1 = img;
  this.evidence$4$1 = evidence$4;
  return this
});
$c_Lnl_amsscala_sjsgameoflive_Hero.prototype.src__T = (function() {
  return "img/hero.png"
});
$c_Lnl_amsscala_sjsgameoflive_Hero.prototype.pos__Lnl_amsscala_sjsgameoflive_package$Position = (function() {
  return this.pos$1
});
function $is_Lnl_amsscala_sjsgameoflive_Hero(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnl_amsscala_sjsgameoflive_Hero)))
}
function $as_Lnl_amsscala_sjsgameoflive_Hero(obj) {
  return (($is_Lnl_amsscala_sjsgameoflive_Hero(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "nl.amsscala.sjsgameoflive.Hero"))
}
function $isArrayOf_Lnl_amsscala_sjsgameoflive_Hero(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnl_amsscala_sjsgameoflive_Hero)))
}
function $asArrayOf_Lnl_amsscala_sjsgameoflive_Hero(obj, depth) {
  return (($isArrayOf_Lnl_amsscala_sjsgameoflive_Hero(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnl.amsscala.sjsgameoflive.Hero;", depth))
}
var $d_Lnl_amsscala_sjsgameoflive_Hero = new $TypeData().initClass({
  Lnl_amsscala_sjsgameoflive_Hero: 0
}, false, "nl.amsscala.sjsgameoflive.Hero", {
  Lnl_amsscala_sjsgameoflive_Hero: 1,
  O: 1,
  Lnl_amsscala_sjsgameoflive_CanvasComponent: 1
});
$c_Lnl_amsscala_sjsgameoflive_Hero.prototype.$classData = $d_Lnl_amsscala_sjsgameoflive_Hero;
/** @constructor */
function $c_Lnl_amsscala_sjsgameoflive_Monster() {
...
$h_Lnl_amsscala_sjsgameoflive_Monster.prototype = $c_Lnl_amsscala_sjsgameoflive_Monster.prototype;
$c_Lnl_amsscala_sjsgameoflive_Monster.prototype.init___Lnl_amsscala_sjsgameoflive_package$Position__Lorg_scalajs_dom_raw_HTMLImageElement = (function(pos, img) {
  this.pos$1 = pos;
  this.img$1 = img;
  return this
});
$c_Lnl_amsscala_sjsgameoflive_Monster.prototype.equals__O__Z = (function(that) {
  return $f_Lnl_amsscala_sjsgameoflive_CanvasComponent__equals__O__Z(this, that)
});
$c_Lnl_amsscala_sjsgameoflive_Monster.prototype.toString__T = (function() {
  return $f_Lnl_amsscala_sjsgameoflive_CanvasComponent__toString__T(this)
});
$c_Lnl_amsscala_sjsgameoflive_Monster.prototype.src__T = (function() {
  return "img/monster.png"
});
$c_Lnl_amsscala_sjsgameoflive_Monster.prototype.pos__Lnl_amsscala_sjsgameoflive_package$Position = (function() {
  return this.pos$1
});
function $is_Lnl_amsscala_sjsgameoflive_Monster(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnl_amsscala_sjsgameoflive_Monster)))
}
function $as_Lnl_amsscala_sjsgameoflive_Monster(obj) {
  return (($is_Lnl_amsscala_sjsgameoflive_Monster(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "nl.amsscala.sjsgameoflive.Monster"))
}
function $isArrayOf_Lnl_amsscala_sjsgameoflive_Monster(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnl_amsscala_sjsgameoflive_Monster)))
}
function $asArrayOf_Lnl_amsscala_sjsgameoflive_Monster(obj, depth) {
  return (($isArrayOf_Lnl_amsscala_sjsgameoflive_Monster(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnl.amsscala.sjsgameoflive.Monster;", depth))
}
var $d_Lnl_amsscala_sjsgameoflive_Monster = new $TypeData().initClass({
  Lnl_amsscala_sjsgameoflive_Monster: 0
}, false, "nl.amsscala.sjsgameoflive.Monster", {
...
$c_Lnl_amsscala_sjsgameoflive_Monster.prototype.$classData = $d_Lnl_amsscala_sjsgameoflive_Monster;
/** @constructor */
function $c_Lnl_amsscala_sjsgameoflive_Playground() {
  $c_O.call(this);
  this.pos$1 = null;
  this.img$1 = null
}
$c_Lnl_amsscala_sjsgameoflive_Playground.prototype = new $h_O();
$c_Lnl_amsscala_sjsgameoflive_Playground.prototype.constructor = $c_Lnl_amsscala_sjsgameoflive_Playground;
/** @constructor */
function $h_Lnl_amsscala_sjsgameoflive_Playground() {
  /*<skip>*/
}
$h_Lnl_amsscala_sjsgameoflive_Playground.prototype = $c_Lnl_amsscala_sjsgameoflive_Playground.prototype;
$c_Lnl_amsscala_sjsgameoflive_Playground.prototype.init___Lnl_amsscala_sjsgameoflive_package$Position__Lorg_scalajs_dom_raw_HTMLImageElement = (function(pos, img) {
  this.pos$1 = pos;
  this.img$1 = img;
  return this
});
$c_Lnl_amsscala_sjsgameoflive_Playground.prototype.equals__O__Z = (function(that) {
  return $f_Lnl_amsscala_sjsgameoflive_CanvasComponent__equals__O__Z(this, that)
});
$c_Lnl_amsscala_sjsgameoflive_Playground.prototype.toString__T = (function() {
  return $f_Lnl_amsscala_sjsgameoflive_CanvasComponent__toString__T(this)
});
$c_Lnl_amsscala_sjsgameoflive_Playground.prototype.src__T = (function() {
  return "img/background.png"
});
$c_Lnl_amsscala_sjsgameoflive_Playground.prototype.pos__Lnl_amsscala_sjsgameoflive_package$Position = (function() {
  return this.pos$1
});
function $is_Lnl_amsscala_sjsgameoflive_Playground(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnl_amsscala_sjsgameoflive_Playground)))
}
function $as_Lnl_amsscala_sjsgameoflive_Playground(obj) {
  return (($is_Lnl_amsscala_sjsgameoflive_Playground(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "nl.amsscala.sjsgameoflive.Playground"))
}
function $isArrayOf_Lnl_amsscala_sjsgameoflive_Playground(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnl_amsscala_sjsgameoflive_Playground)))
}
function $asArrayOf_Lnl_amsscala_sjsgameoflive_Playground(obj, depth) {
  return (($isArrayOf_Lnl_amsscala_sjsgameoflive_Playground(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnl.amsscala.sjsgameoflive.Playground;", depth))
}
var $d_Lnl_amsscala_sjsgameoflive_Playground = new $TypeData().initClass({
  Lnl_amsscala_sjsgameoflive_Playground: 0
}, false, "nl.amsscala.sjsgameoflive.Playground", {
  Lnl_amsscala_sjsgameoflive_Playground: 1,
  O: 1,
  Lnl_amsscala_sjsgameoflive_CanvasComponent: 1
});
$c_Lnl_amsscala_sjsgameoflive_Playground.prototype.$classData = $d_Lnl_amsscala_sjsgameoflive_Playground;
...
/** @constructor */
function $c_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$() {
  $c_O.call(this);
  this.origin$1 = null;
  this.nl$amsscala$sjsgameoflive$Page$$postponed$1 = null;
  this.canvas$1 = null;
  this.nl$amsscala$sjsgameoflive$Page$$ctx$1 = null;
  this.nl$amsscala$sjsgameoflive$Page$$cellSize$1 = 0;
  this.bitmap$0$1 = 0
}
$c_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$.prototype = new $h_O();
$c_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$.prototype.constructor = $c_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$;
/** @constructor */
function $h_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$() {
  /*<skip>*/
}
$h_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$.prototype = $c_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$.prototype;
$c_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$.prototype.nl$amsscala$sjsgameoflive$Page$$postponed$lzycompute__p1__Lorg_scalajs_dom_raw_Node = (function() {
  if (((2 & this.bitmap$0$1) === 0)) {
    this.nl$amsscala$sjsgameoflive$Page$$postponed$1 = $f_Lnl_amsscala_sjsgameoflive_Page__nl$amsscala$sjsgameoflive$Page$$postponed__Lorg_scalajs_dom_raw_Node(this);
    this.bitmap$0$1 = (((2 | this.bitmap$0$1) << 24) >> 24)
  };
  return this.nl$amsscala$sjsgameoflive$Page$$postponed$1
});
$c_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$.prototype.init___ = (function() {
  $n_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$ = this;
  $f_Lnl_amsscala_sjsgameoflive_Page__$$init$__V(this);
  return this
});
$c_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$.prototype.nl$amsscala$sjsgameoflive$Page$$postponed__Lorg_scalajs_dom_raw_Node = (function() {
  return (((2 & this.bitmap$0$1) === 0) ? this.nl$amsscala$sjsgameoflive$Page$$postponed$lzycompute__p1__Lorg_scalajs_dom_raw_Node() : this.nl$amsscala$sjsgameoflive$Page$$postponed$1)
});
$c_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$.prototype.origin$lzycompute__p1__Lnl_amsscala_sjsgameoflive_package$Position = (function() {
  if (((1 & this.bitmap$0$1) === 0)) {
    this.origin$1 = $f_Lnl_amsscala_sjsgameoflive_Page__origin__Lnl_amsscala_sjsgameoflive_package$Position(this);
    this.bitmap$0$1 = (((1 | this.bitmap$0$1) << 24) >> 24)
  };
  return this.origin$1
});
$c_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$.prototype.origin__Lnl_amsscala_sjsgameoflive_package$Position = (function() {
  return (((1 & this.bitmap$0$1) === 0) ? this.origin$lzycompute__p1__Lnl_amsscala_sjsgameoflive_package$Position() : this.origin$1)
});
$c_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$.prototype.$$js$exported$meth$main__O = (function() {
  var canvas = this.canvas$1;
  $f_Lnl_amsscala_sjsgameoflive_Game__play__Lorg_scalajs_dom_raw_HTMLCanvasElement__Z__V(this, canvas, false)
});
$c_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$ = new $TypeData().initClass({
  Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$: 0
}, false, "nl.amsscala.sjsgameoflive.SimpleCanvasGame$", {
  Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$: 1,
  O: 1,
  sjs_js_JSApp: 1,
  Lnl_amsscala_sjsgameoflive_Game: 1,
  Lnl_amsscala_sjsgameoflive_Page: 1
});
$c_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$.prototype.$classData = $d_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$;
var $n_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$ = (void 0);
function $m_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$() {
  if ((!$n_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$)) {
    $n_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$ = new $c_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$().init___()
  };
  return $n_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$
}
$e.nl = ($e.nl || {});
$e.nl.amsscala = ($e.nl.amsscala || {});
$e.nl.amsscala.sjsgameoflive = ($e.nl.amsscala.sjsgameoflive || {});
$e.nl.amsscala.sjsgameoflive.SimpleCanvasGame = $m_Lnl_amsscala_sjsgameoflive_SimpleCanvasGame$;
function $is_T(obj) {
...
$c_sjsr_RuntimeLong.prototype.$classData = $d_sjsr_RuntimeLong;
/** @constructor */
function $c_Lnl_amsscala_sjsgameoflive_package$Position() {
  $c_O.call(this);
  this.x$1 = null;
  this.y$1 = null;
  this.nl$amsscala$sjsgameoflive$Position$$evidence$1$f = null
}
$c_Lnl_amsscala_sjsgameoflive_package$Position.prototype = new $h_O();
$c_Lnl_amsscala_sjsgameoflive_package$Position.prototype.constructor = $c_Lnl_amsscala_sjsgameoflive_package$Position;
/** @constructor */
function $h_Lnl_amsscala_sjsgameoflive_package$Position() {
  /*<skip>*/
}
$h_Lnl_amsscala_sjsgameoflive_package$Position.prototype = $c_Lnl_amsscala_sjsgameoflive_package$Position.prototype;
$c_Lnl_amsscala_sjsgameoflive_package$Position.prototype.productPrefix__T = (function() {
  return "Position"
});
$c_Lnl_amsscala_sjsgameoflive_package$Position.prototype.productArity__I = (function() {
  return 2
});
$c_Lnl_amsscala_sjsgameoflive_package$Position.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lnl_amsscala_sjsgameoflive_package$Position(x$1)) {
    var Position$1 = $as_Lnl_amsscala_sjsgameoflive_package$Position(x$1);
    return ($m_sr_BoxesRunTime$().equals__O__O__Z(this.x$1, Position$1.x$1) && $m_sr_BoxesRunTime$().equals__O__O__Z(this.y$1, Position$1.y$1))
  } else {
    return false
  }
});
$c_Lnl_amsscala_sjsgameoflive_package$Position.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.x$1;
      break
...
$c_Lnl_amsscala_sjsgameoflive_package$Position.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lnl_amsscala_sjsgameoflive_package$Position.prototype.$$times__O__Lnl_amsscala_sjsgameoflive_package$Position = (function(factor) {
  var x = this.x$1;
  var num = this.nl$amsscala$sjsgameoflive$Position$$evidence$1$f;
  var jsx$1 = new $c_s_math_Numeric$Ops().init___s_math_Numeric__O(num, x).$$times__O__O(factor);
  var x$1 = this.y$1;
  var num$1 = this.nl$amsscala$sjsgameoflive$Position$$evidence$1$f;
  return new $c_Lnl_amsscala_sjsgameoflive_package$Position().init___O__O__s_math_Numeric(jsx$1, new $c_s_math_Numeric$Ops().init___s_math_Numeric__O(num$1, x$1).$$times__O__O(factor), this.nl$amsscala$sjsgameoflive$Position$$evidence$1$f)
});
$c_Lnl_amsscala_sjsgameoflive_package$Position.prototype.areTouching__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position__Z = (function(posB, side) {
  return this.interSectsArea__p1__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position__Z(this, this.$$plus__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position(side), posB, posB.$$plus__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position(side))
});
$c_Lnl_amsscala_sjsgameoflive_package$Position.prototype.interSectsArea__p1__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position__Z = (function(p0, p1, p2, p3) {
  var a0 = p0.x$1;
  var b0 = p1.x$1;
  var a1 = p2.x$1;
  var b1 = p3.x$1;
  var ord = this.nl$amsscala$sjsgameoflive$Position$$evidence$1$f;
  if (new $c_s_math_Ordering$Ops().init___s_math_Ordering__O(ord, a0).$$less$eq__O__Z(b1)) {
    var ord$1 = this.nl$amsscala$sjsgameoflive$Position$$evidence$1$f;
    var jsx$1 = new $c_s_math_Ordering$Ops().init___s_math_Ordering__O(ord$1, a1).$$less$eq__O__Z(b0)
  } else {
    var jsx$1 = false
  };
  if (jsx$1) {
    ...
    var a1$1 = p2.y$1;
    var b1$1 = p3.y$1;
    var ord$2 = this.nl$amsscala$sjsgameoflive$Position$$evidence$1$f;
    if (new $c_s_math_Ordering$Ops().init___s_math_Ordering__O(ord$2, a0$1).$$less$eq__O__Z(b1$1)) {
      var ord$3 = this.nl$amsscala$sjsgameoflive$Position$$evidence$1$f;
      return new $c_s_math_Ordering$Ops().init___s_math_Ordering__O(ord$3, a1$1).$$less$eq__O__Z(b0$1)
    } else {
      return false
    }
  } else {
...
$c_Lnl_amsscala_sjsgameoflive_package$Position.prototype.init___O__O__s_math_Numeric = (function(x, y, evidence$1) {
  this.x$1 = x;
  this.y$1 = y;
  this.nl$amsscala$sjsgameoflive$Position$$evidence$1$f = evidence$1;
  return this
});
$c_Lnl_amsscala_sjsgameoflive_package$Position.prototype.$$plus__O__Lnl_amsscala_sjsgameoflive_package$Position = (function(term) {
  var x = this.x$1;
  var num = this.nl$amsscala$sjsgameoflive$Position$$evidence$1$f;
  var jsx$1 = new $c_s_math_Numeric$Ops().init___s_math_Numeric__O(num, x).$$plus__O__O(term);
  var x$1 = this.y$1;
  var num$1 = this.nl$amsscala$sjsgameoflive$Position$$evidence$1$f;
  return new $c_Lnl_amsscala_sjsgameoflive_package$Position().init___O__O__s_math_Numeric(jsx$1, new $c_s_math_Numeric$Ops().init___s_math_Numeric__O(num$1, x$1).$$plus__O__O(term), this.nl$amsscala$sjsgameoflive$Position$$evidence$1$f)
});
$c_Lnl_amsscala_sjsgameoflive_package$Position.prototype.$$minus__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position = (function(p) {
  var x = this.x$1;
  var num = this.nl$amsscala$sjsgameoflive$Position$$evidence$1$f;
  var jsx$1 = new $c_s_math_Numeric$Ops().init___s_math_Numeric__O(num, x).$$minus__O__O(p.x$1);
  var x$1 = this.y$1;
  var num$1 = this.nl$amsscala$sjsgameoflive$Position$$evidence$1$f;
  return new $c_Lnl_amsscala_sjsgameoflive_package$Position().init___O__O__s_math_Numeric(jsx$1, new $c_s_math_Numeric$Ops().init___s_math_Numeric__O(num$1, x$1).$$minus__O__O(p.y$1), this.nl$amsscala$sjsgameoflive$Position$$evidence$1$f)
});
$c_Lnl_amsscala_sjsgameoflive_package$Position.prototype.mooreNeighborHood__I__sci_Set = (function(r) {
  var x = ((-r) | 0);
  var range = new $c_sci_Range$Inclusive().init___I__I__I(x, r, 1);
  $m_sci_IndexedSeq$();
  $m_sc_IndexedSeq$();
  $m_sci_IndexedSeq$();
  $m_sci_Vector$();
  ...
  if ((!range.isEmpty$4)) {
    ...
    while (true) {
      var arg1 = i;
      var p = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, r$1, x$1) {
        return (function(y$2) {
          var y = $uI(y$2);
          return (((x$1 | y) !== 0) || (r$1 === 0))
        })
      })(this, r, arg1));
      var this$8 = $as_sci_IndexedSeq(new $c_sc_TraversableLike$WithFilter().init___sc_TraversableLike__F1(range, p).map__F1__scg_CanBuildFrom__O(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$2$1, x$2) {
        return (function(y$3$2) {
          var y$3 = $uI(y$3$2);
          return new $c_Lnl_amsscala_sjsgameoflive_package$Position().init___O__O__s_math_Numeric(x$2, y$3, $m_s_math_Numeric$IntIsIntegral$())
        })
      })(this, arg1)), ($m_sci_IndexedSeq$(), $m_sc_IndexedSeq$().ReusableCBF$6)));
      $as_sci_VectorBuilder($f_scg_Growable__$$plus$plus$eq__sc_TraversableOnce__scg_Growable(b, this$8));
      if ((i === range.scala$collection$immutable$Range$$lastElement$4)) {
        break
      };
      i = ((i + range.step$4) | 0)
    }
  ...
  var b$1 = $f_sc_TraversableLike__builder$1__psc_TraversableLike__scg_CanBuildFrom__scm_Builder(this$10, bf$1);
  var this$11 = this$10.iterator__sci_VectorIterator();
  while (this$11.$$undhasNext$2) {
    var arg1$1 = this$11.next__O();
    var x$1$1 = $as_Lnl_amsscala_sjsgameoflive_package$Position(arg1$1);
    b$1.$$plus$eq__O__scm_Builder(x$1$1.$$plus__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position(this))
  };
  return $as_sc_TraversableOnce(b$1.result__O()).toSet__sci_Set()
});
$c_Lnl_amsscala_sjsgameoflive_package$Position.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lnl_amsscala_sjsgameoflive_package$Position.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_Lnl_amsscala_sjsgameoflive_package$Position.prototype.$$plus__Lnl_amsscala_sjsgameoflive_package$Position__Lnl_amsscala_sjsgameoflive_package$Position = (function(p) {
  var x = this.x$1;
  var num = this.nl$amsscala$sjsgameoflive$Position$$evidence$1$f;
  var jsx$1 = new $c_s_math_Numeric$Ops().init___s_math_Numeric__O(num, x).$$plus__O__O(p.x$1);
  var x$1 = this.y$1;
  var num$1 = this.nl$amsscala$sjsgameoflive$Position$$evidence$1$f;
  return new $c_Lnl_amsscala_sjsgameoflive_package$Position().init___O__O__s_math_Numeric(jsx$1, new $c_s_math_Numeric$Ops().init___s_math_Numeric__O(num$1, x$1).$$plus__O__O(p.y$1), this.nl$amsscala$sjsgameoflive$Position$$evidence$1$f)
});
function $is_Lnl_amsscala_sjsgameoflive_package$Position(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnl_amsscala_sjsgameoflive_package$Position)))
}
function $as_Lnl_amsscala_sjsgameoflive_package$Position(obj) {
  return (($is_Lnl_amsscala_sjsgameoflive_package$Position(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "nl.amsscala.sjsgameoflive.package$Position"))
}
function $isArrayOf_Lnl_amsscala_sjsgameoflive_package$Position(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnl_amsscala_sjsgameoflive_package$Position)))
}
function $asArrayOf_Lnl_amsscala_sjsgameoflive_package$Position(obj, depth) {
  return (($isArrayOf_Lnl_amsscala_sjsgameoflive_package$Position(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnl.amsscala.sjsgameoflive.package$Position;", depth))
}
var $d_Lnl_amsscala_sjsgameoflive_package$Position = new $TypeData().initClass({
  Lnl_amsscala_sjsgameoflive_package$Position: 0
}, false, "nl.amsscala.sjsgameoflive.package$Position", {
  Lnl_amsscala_sjsgameoflive_package$Position: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lnl_amsscala_sjsgameoflive_package$Position.prototype.$classData = $d_Lnl_amsscala_sjsgameoflive_package$Position;
/** @constructor */
...
function $f_sc_TraversableLike__groupBy__F1__sci_Map($thiz, f) {
  ...
  $thiz.foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, f$1, m$1) {
    return (function(elem$2) {
      ...
      var hcode = $m_sr_Statics$().anyHash__O__I(key);
      var i = $f_scm_HashTable__index__I__I(m$1, hcode);
      var entry = m$1.findEntry__p5__O__I__scm_DefaultEntry(key, i);
      if ((entry !== null)) {
        var jsx$1 = entry.value$1
      } else {
        var value = $this.newBuilder__scm_Builder();
        var jsx$1 = m$1.addEntry__p5__scm_DefaultEntry__I__O(new $c_scm_DefaultEntry().init___O__O(key, value), i)
      };
...
$c_s_math_Numeric$DoubleIsFractional$.prototype.minus__O__O__O = (function(x, y) {
  var x$1 = $uD(x);
  var y$1 = $uD(y);
...
$c_Lscalatags_JsDom$all$.prototype.title$lzycompute__p1__Lscalatags_generic_Attr = (function() {
  var b = this.bitmap$4$1;
  var hi = (16 & b.hi$2);
  if ((hi === 0)) {
    this.title$1 = $f_Lscalatags_generic_Util__attr__T__Lscalatags_generic_Namespace__Z__Lscalatags_generic_Attr(this, "title", null, false);
    var b$1 = this.bitmap$4$1;
    var lo = b$1.lo$2;
...
$c_Lscalatags_JsDom$all$.prototype.title__Lscalatags_generic_Attr = (function() {
  var b = this.bitmap$4$1;
  var hi = (16 & b.hi$2);
  if ((hi === 0)) {
    return this.title$lzycompute__p1__Lscalatags_generic_Attr()
  } else {
    return this.title$1
  }
});
...
$c_scm_HashMap.prototype.addEntry0__p5__scm_DefaultEntry__I__V = (function(e, h) {
  var x$1 = $as_scm_DefaultEntry(this.table$5.u[h]);
  e.next$1 = x$1;
  this.table$5.u[h] = e;
...
$c_scm_HashMap.prototype.findEntry__p5__O__I__scm_DefaultEntry = (function(key, h) {
  var e = $as_scm_DefaultEntry(this.table$5.u[h]);
...
$c_scm_HashSet.prototype.$$minus$eq__O__scm_HashSet = (function(elem) {
  $f_scm_FlatHashTable__removeElem__O__Z(this, elem);
  return this
});
...
$c_scm_HashSet.prototype.$$plus$plus__sc_GenTraversableOnce__sc_Set = (function(elems) {
  ...
  return $as_scm_Set($f_scg_Growable__$$plus$plus$eq__sc_TraversableOnce__scg_Growable(this$2, xs))
});
...
//# sourceMappingURL=main-fastopt.js.map
