...
object Monster {
  ...
  private[sjsgameoflive] def randomPosition[M: Numeric](canvas: dom.html.Canvas): Position[M] = {
...
final class Hero[H: Numeric](val pos: Position[H], val img: dom.raw.HTMLImageElement) extends CanvasComponent[H] {
  ...
  /**
    ...
    */
  protected[sjsgameoflive] def isValidPosition(canvas: dom.html.Canvas) =
  ...
  /**
    ...
    */
  protected[sjsgameoflive] def keyEffect(latency: Double, keysDown: mutable.Set[Int]): Hero[H] = {
...
object Hero {
  protected[sjsgameoflive] val (pxSize, speed) = (32, 256)
